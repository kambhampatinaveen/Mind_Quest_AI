...
function getStatusBadge(score) {
  ...
  return { text: "Unplayed", className: "badge-none" };
}

export default function SkillCard({ skill, score = 0, level = 1 }) {
    ...
    <div className={`skill-card-neo ${config.colorClass}`}>
      ...
      <div className="skill-card-body">
        <div className="skill-card-left">
          ...
          <span style={{ color: config.accentColor, fontSize: "0.75rem", marginTop: "0.35rem" }}>Level {level}</span>
        </div>
